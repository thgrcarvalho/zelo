...
/**
 * Marks a Postgres-backed integration test. Bundles {@link SpringBootTest},
 * Testcontainers support and the {@code -DrunIntegrationTests=true} gate so the
 * default {@code ./gradlew test} stays fast and Docker-free.
 *
 * <p>Apply this to the concrete test class and extend {@link AbstractIntegrationTest}
 * to get the shared Postgres container. The gate must sit on the concrete class:
